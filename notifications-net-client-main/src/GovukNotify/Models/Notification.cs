...
public class Notification
{
    ...
    [JsonProperty("cost_details")] public CostDetails costDetails;

    [JsonProperty("cost_in_pounds")] public double? costInPounds;

    [JsonProperty("created_at")] public string createdAt;

    [JsonProperty("created_by_name")] public string createdByName;

    [JsonProperty("email_address")] public string emailAddress;

    public string id;

    [JsonProperty("is_cost_data_ready")] public bool isCostDataReady;

    [JsonProperty("line_1")] public string line1;

    [JsonProperty("line_2")] public string line2;

    [JsonProperty("line_3")] public string line3;

    [JsonProperty("line_4")] public string line4;

    [JsonProperty("line_5")] public string line5;

    [JsonProperty("line_6")] public string line6;
    ...
    {
        if (!(notification is Notification note)) return false;
